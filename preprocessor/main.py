...
def run(path, mapping_path, do_db, do_mapping, clean_mapping):
    # Clean mapping
    ...
    if do_db:
        processor.process(mapping, path)


if __name__ == '__main__':
    args = parser.parse_args()
    run(args.path, args.mapping, args.do_db, args.do_mapping, args.clean_mapping)
