...
parser.set_defaults(do_db=True, do_mapping=True, clean_mapping=False,
                    do_idf_dict=True, clean_idf_dict=False, drop_db=False)


def run(path, mapping_path, idf_dict_path, db_password, do_db,
        do_mapping, clean_mapping, do_idf_dict, clean_idf_dict, drop):
...
if __name__ == '__main__':
    ...
    run(args.path, args.mapping, args.idf_dict, args.password, args.do_db,
        args.do_mapping, args.clean_mapping, args.do_idf_dict, args.clean_idf_dict, args.drop_db)
